...
from src.method.api_component.base_architecture import APIsNN
from src.method.api_component.tfreader import make_dataset
from src.method.utils import load_parameters
from sklearn.metrics import confusion_matrix

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='API-based NN Model Training')
